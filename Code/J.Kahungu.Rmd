...
# Plot by region
# Modified HIV Regional Trends Plot
...
ggsave(
  filename = "HIV Trends for Top 75% Contributors by WHO Region.png",  
  plot     = plot_region,    
  width    = 10,             
  height   = 8,              
  dpi      = 300             
...
mortality_data <- read.csv(file.choose())  

# Cleaning data
clean_data <- mortality_data %>%
  # Standardizing country names
  mutate(Geographic.area = case_when(
...
message("Saved to: ", getwd(), "/EAC_shapes_outline.png")
